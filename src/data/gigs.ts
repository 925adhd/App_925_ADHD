...
export const gigs: Gig[] = [
  ...
  { id: "paidviewpoint", name: "Paid Viewpoint", rate: "$1–$3/hr", desc: "Short surveys. Still pays you even if you don't qualify.", logo: "https://storage.googleapis.com/glide-prod.appspot.com/uploads-v2/bIquIPZf7ZEXDA4vlm8R/pub/X4p6CA7iYfoM0LyEDUxQ.png", link: "https://paidviewpoint.com/", category: "surveys", energy: "low", tags: ["beginner", "quick"], browser: false, fave: true },
  ...
  { id: "fieldagent", name: "Field Agent", rate: "$3–$20/task", desc: "Quick in-person tasks while you're out. Price checks, photos, store audits.", logo: "https://storage.googleapis.com/glide-prod.appspot.com/uploads-v2/bIquIPZf7ZEXDA4vlm8R/pub/bJvEwgxE41M5YKf5NNUc.png", link: "https://app.fieldagent.net/", category: "realtasks", energy: "low", tags: ["quick", "beginner"], browser: false, fave: true },
  ...
  { id: "modeearn", name: "Mode Earn", rate: "$10–$50/mo", desc: "Android only. Earns in the background while you charge or scroll.", logo: "https://storage.googleapis.com/glide-prod.appspot.com/uploads-v2/bIquIPZf7ZEXDA4vlm8R/pub/x2dOwyvRkTLnqbXD6fee.jpg", link: "https://play.google.com/store/apps/details?id=us.current.android", category: "rewards", energy: "low", tags: ["beginner", "quick"], browser: false, fave: true },
  ...
  { id: "mistplay", name: "Mistplay", rate: "$5–$20/mo", desc: "Play games for rewards. Now on iOS too. Slower than it used to be.", logo: "https://storage.googleapis.com/glide-prod.appspot.com/uploads-v2/bIquIPZf7ZEXDA4vlm8R/pub/rCXLcdy5K4EBVE2fQPdW.jpg", link: "https://www.mistplay.com/", category: "rewards", energy: "low", tags: ["beginner", "quick"], browser: false, fave: true },
  ...
  { id: "honeygain", name: "Honeygain", rate: "$2–$8/mo", desc: "Earns pennies for sharing your unused internet. Slow payouts.", logo: "https://storage.googleapis.com/glide-prod.appspot.com/uploads-v2/bIquIPZf7ZEXDA4vlm8R/pub/XFzVcPA2ZQRwdAl1iyVM.png", link: "https://honeygain.com/", category: "passive", energy: "low", tags: ["beginner"], browser: false, fave: true },
