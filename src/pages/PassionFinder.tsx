...
const PLATFORMS: Platform[] = [
  ...
  { name: 'YouTube', desc: 'Video content creation - tutorials, vlogs, reviews, or educational content', earning: '$200-10000+/month', timeToStart: '3-6 months to monetize', difficulty: 'hard', skills: ['communication', 'creative', 'tech'], timeCommitment: ['serious'], energy: ['motivated'], income: ['serious-income', 'replacement'], url: 'https://www.youtube.com/creators/', category: 'Social Media & Content' },
